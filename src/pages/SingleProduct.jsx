...
function SingleProduct() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const request = fetch("https://dummyjson.com/product/" + id);
  ...
  return (
    <div className="flex p-4 max-w-[1240px] mx-auto">
      <div className="flex flex-col sm:flex-row sm:justify-between md:flex-row md:justify-between lg:flex-row md;justify-between xl:flex-row">
        {/* Left Image Gallery */}
        <div className="w-1/4 ">
